...
public class HealthController : MapController{
    private GamePlayer player;
	public GameObject uiRoot = GameObject.Find("UI Root");
	private static MapController instance = new HealthController();
    ...
    public override void triggerEvents(){
        GameObject messageBox = Resources.Load("prefabs/UI/healthWindow") as GameObject;
